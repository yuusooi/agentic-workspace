  ...
  return (
    <>
      ...
      <div style={{ flex: 1, overflowY: 'auto', padding: '20px 32px' }}>
        {activeTab === 'overview' ? (
          <ProjectOverview project={project} isOwner={isOwner} />
        ) : (
          <>
            <TaskFilterBar />
            <TaskList />
      ...
      {/* Task Drawer (always mounted, controls its own visibility) */}
      <TaskDrawer />
    </>
  );
}
  ...
  return (
    <div
      ...
      style={{
        ...
        cursor: 'pointer',
        borderBottom: active ? '2px solid #0075de' : '2px solid transparent',
        transition: 'all .15s',
      }}
    >
      {icon}
